...
#define _80_SCI_CLOCK_SYNCHRONOUS_MODE            (0x80U) /* Clock synchronous mode or Simple SPI mode */
...
#define TX_QUEUE_MAX_SIZE 24
struct Tx_Circle_Queue{
	uint8_t * array;
	uint16_t count;
	uint16_t sent;
...
uint16_t sci1_receive_available(void);
...
uint8_t Bluetooth_eat_one(void);
//                       ---end---
