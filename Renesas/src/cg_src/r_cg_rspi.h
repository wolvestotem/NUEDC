...
#define _00_RSPI_AUTO_STOP_DISABLED             (0x00U) /* Disables the RSPCK auto-stop function */
#define _10_RSPI_AUTO_STOP_ENABLED              (0x10U) /* Enables the RSPCK auto-stop function */
